...
Dokumentaatiossa on saatavilla asennus, (loppu)käyttäjän käyttöohjeet, tietokanta-kaavio, user storyt, käyttöehdot (tulossa myöhemmin) ja tietoja yksityisyydestä, joka sisältää muun muassa tietojen käytön ja käsittelyn.
